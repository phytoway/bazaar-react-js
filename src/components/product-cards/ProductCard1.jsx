  ...
  return <StyledBazaarCard hoverEffect={hoverEffect}>
      <ImageWrapper>
        ...
        <Link href={`/product/${slug}`}>
          <a>
            <LazyImage  src={imgUrl ? imgUrl : '/assets/images/products/phytoway/pantomona1.png'} width={0} height={0} layout="responsive" alt={title} />
          </a>
        </Link>
      </ImageWrapper>
      ...
      <ContentWrapper>
        <FlexBox>
          <Box flex="1 1 0" minWidth="0px" mr={1}>
            ...
            {!hideRating && <BazaarRating value={rating || 0} precision={0.5} color="warn" readOnly />}
            ...
            <FlexBox alignItems="center" gap={1} mt={0.5}>
              ...
              {!!discount && <Box color="grey.600" fontWeight="600">
                  <del>{currency(original_price)}</del>
                </Box>}
            </FlexBox>
          </Box>
